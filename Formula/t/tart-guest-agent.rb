...
class TartGuestAgent < Formula
  ...
  if OS.mac?
    url "https://github.com/openai/tart-guest-agent/releases/download/v#{version}/tart-guest-agent-darwin-all.tar.gz"
    sha256 "28e1b698c726c5f1d0f8c9d086b3390f6407d47e3f4b83081d9b2a9a2a1f0bc7"
  end

  if OS.linux? && Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
    url "https://github.com/openai/tart-guest-agent/releases/download/v#{version}/tart-guest-agent-linux-amd64.tar.gz"
    sha256 "0b2dab17ffa74a05f47837131cb7249cd0912ddaf5a20aa00a600b7e2d08dc01"
  end

  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url "https://github.com/openai/tart-guest-agent/releases/download/v#{version}/tart-guest-agent-linux-arm64.tar.gz"
